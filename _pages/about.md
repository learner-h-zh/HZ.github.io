...
<h1><img src="./images/svg_2.svg" alt="icon" style="width: 40px; height: 40px; margin-right: 15px;"> Experience</h1>
...
- <p>May 2025, my first paper was accepted by the Applied Science journal,This will be the beginning of my new journey!<img src="./images/svg_3.svg" alt="icon" style="width: 30px; height: 30px; margin-right: 10px;"></p>
